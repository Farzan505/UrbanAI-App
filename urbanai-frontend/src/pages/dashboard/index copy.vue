...
// Sample data for the urban development chart
const chartData = {
  labels: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun'],
  datasets: [
    {
      label: 'Urban Development Index',
...
const formatValue = (tick: number | string, index: number): string => {
    ...
    <div class="flex flex-col gap-6">
      ...
      <div class="w-full">
        ...
        <div class="mt-4 h-[calc(100vh-16rem)]">
          ...
          <!-- Analytics Tab -->
          <div v-if="activeTab === 1" class="h-full space-y-6">
            <!-- Urban Development Chart -->
            <div class="p-4 border rounded-lg bg-card">
              <h3 class="text-lg font-medium mb-4">Urban Development Trends</h3>
              <LineChart
                :data="chartData"
                :options="{
                  responsive: true,
                  ...
                  plugins: {
                    ...
                    title: {
                      display: true,
                      text: 'Monthly Urban Development Progress'
                    }
                  },
                  scales: {
                    y: {
